"""
ARCHIWUM - starszy program: pomiar napiecia na wejsciach analogowych AI0/AI1 karty NI.
Nie jest potrzebny do licznika Geigera (glowny program: geiger_gui.py).
Przeniesiony tu z README bez zmian w kodzie.
"""
